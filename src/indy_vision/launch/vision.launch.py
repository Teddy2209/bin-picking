...
def generate_launch_description():
    ...
    calib_broadcaster_script = "/home/apicoo-ai/pmg/bin_picking_ws/src/indy_vision/indy_vision/calibration_broadcaster_oldversion.py"
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name='calibration_broadcaster_oldversion',
            output='screen',
            emulate_tty=True
        )
    ])
